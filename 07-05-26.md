...
```
Después descargá el AppImage desde [qgroundcontrol.com](qgroundcontrol.com). Es un solo archivo ejecutable, no requiere instalación:
```c
bash
...
1. Andá a la pestaña **Plan** (icono de mapa con waypoints).
2. Hacé clic en el mapa para crear waypoints.
3. Tocá **Upload** para subir la misión al "dron".
4. Volvé a la pestaña **Fly.**
5. Tocá **Slide to confirm — Start mission.**
...
- Verifica batería cargada al 100 %, hélices apretadas, todo aterrizable.
