...
Si necesitas crear un directorio dentro de otra computadora o servidor usando SSH desde tu terminal WSL, primero conéctate al servidor y luego ejecuta el comando de creación:Conéctate a tu servidor remoto:
``` c
bash 
